...
!(function (e, t) {
          ...
          if (null != (e = arguments[a]))
            for (t in e)
              (o = e[t]),
                "__proto__" !== t &&
                  r !== o &&
                  (c && o && (T.isPlainObject(o) || (i = Array.isArray(o)))
                    ? ((n = r[t]),
                      (s =
                        i && !Array.isArray(n)
                          ? []
  ...
  !(function () {
    ...
    try {
      v.apply((n = i.call(j.childNodes)), j.childNodes),
    ...
    function J(e, t, n, o) {
      ...
      if (!o && (le(t), (t = t || c), p)) {
        if (11 !== y && (l = U.exec(e)))
          if ((i = l[1])) {
            if (9 === y) {
              ...
              if (r.id === i) return v.call(n, r), n;
            } else if (
              g &&
              (r = g.getElementById(i)) &&
              J.contains(t, r) &&
              r.id === i
            )
              return v.call(n, r), n;
        ...
        if (!(L[e + " "] || (h && h.test(e)))) {
          if (((u = e), (g = t), 1 === y && (R.test(e) || N.test(e)))) {
            for (
              ((g = (V.test(e) && ae(t.parentNode)) || t) == t && f.scope) ||
                ((a = t.getAttribute("id"))
          ...
          try {
            return v.apply(n, g.querySelectorAll(u)), n;
          } catch (t) {
            L(e, !0);
          } finally {
          ...
          (D = function (e, t) {
            ...
            return (
              ...
              (!f.sortDetached && t.compareDocumentPosition(e) === n)
                ? e === c || (e.ownerDocument == j && J.contains(j, e))
                  ? -1
                  : t === c || (t.ownerDocument == j && J.contains(j, t))
                  ? 1
                  : r
    ...
    (J.attr = function (e, t) {
      ...
      var n = o.attrHandle[t.toLowerCase()],
        i = n && d.call(o.attrHandle, t.toLowerCase()) ? n(e, t, !p) : void 0;
    ...
    (T.uniqueSort = function (e) {
      ...
      if (
        ((l = !f.sortStable),
        (r = !f.sortStable && i.call(e, 0)),
        $.call(e, D),
        l)
      ) {
        for (; (t = e[s++]); ) t === e[s] && (o = n.push(s));
        for (; o--; ) P.call(e, n[o], 1);
      }
      return (r = null), e;
    }),
    ...
    (o = T.expr =
      {
        ...
        pseudos: {
          ...
          checked: function (e) {
            return (
              (k(e, "input") && !!e.checked) || (k(e, "option") && !!e.selected)
            );
          },
          selected: function (e) {
            return (
          ...
          lt: re(function (e, t, n) {
            var o;
            for (o = n < 0 ? n + t : n > t ? t : n; --o >= 0; ) e.push(o);
            return e;
          }),
    ...
    { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
      o.pseudos[t] = oe(t);
    for (t in { submit: !0, reset: !0 }) o.pseudos[t] = ie(t);
    function ce() {}
    function de(e, t) {
      var n,
        i,
      ...
      for (a = e, l = [], c = o.preFilter; a; ) {
        for (r in ((n && !(i = F.exec(a))) ||
          (i && (a = a.slice(i[0].length) || a), l.push((s = []))),
        (n = !1),
        (i = N.exec(a)) &&
          ((n = i.shift()),
          s.push({ value: n, type: i[0].replace(E, " ") }),
          (a = a.slice(n.length))),
        o.filter))
          !(i = _[r].exec(a)) ||
            (c[r] && !(i = c[r](i))) ||
      ...
      return t ? a.length : a ? J.error(e) : w(e, l).slice(0);
    }
    function ue(e) {
        ...
        te(function (s, r, l, c) {
          var d,
            ...
            y =
              s ||
              (function (e, t, n) {
                for (var o = 0, i = t.length; o < i; o++) J(e, t[o], n);
                return n;
              })(t || "*", l.nodeType ? [l] : l, []),
            b = !e || (!s && t) ? y : he(y, h, e, l, c);
          if (
            (n ? n(b, (f = i || (s ? e : m || o) ? [] : r), l, c) : (f = b), o)
          )
            for (d = he(f, g), o(d, [], l, c), u = d.length; u--; )
              (p = d[u]) && (f[g[u]] = !(b[g[u]] = p));
          if (s) {
            if (i || e) {
              if (i) {
              ...
              for (u = f.length; u--; )
                (p = f[u]) &&
                  (d = i ? a.call(s, p) : h[u]) > -1 &&
                  (s[d] = !(r[d] = p));
            }
          } else (f = he(f === r ? f.splice(m, f.length) : f)), i ? i(null, r, f, c) : v.apply(r, f);
        })
      );
    }
    function ve(e) {
      for (
        ...
        if ((n = o.relative[e[d].type])) f = [pe(fe(f), n)];
        else {
          if ((n = o.filter[e[d].type].apply(null, e[d].matches))[m]) {
            for (i = ++d; i < r && !o.relative[e[i].type]; i++);
            return ge(
              d > 1 && fe(f),
              d > 1 &&
                ue(
    ...
    function me(e, t) {
      ...
      if (!a) {
        for (t || (t = de(e)), n = t.length; n--; )
          (a = ve(t[n]))[m] ? i.push(a) : r.push(a);
        (a = S(
          e,
          (function (e, t) {
            var n = t.length > 0,
              i = e.length > 0,
              r = function (r, a, l, d, u) {
                var f,
                  h,
                  g,
                  m = 0,
                ...
                for (
                  ...
                  if (i && f) {
                    for (
                      h = 0, a || f.ownerDocument == c || (le(f), (l = !p));
                      (g = e[h++]);
                  ...
                  n && ((f = !g && f) && m--, r && x.push(f));
                }
                if (((m += b), n && b !== m)) {
                  for (h = 0; (g = t[h++]); ) g(x, w, a, l);
                  if (r) {
                    if (m > 0) for (; b--; ) x[b] || w[b] || (w[b] = C.call(d));
                    w = he(w);
                  }
                  v.apply(d, w),
                    u &&
    ...
    function ye(e, t, n, i) {
      ...
      if (((n = n || []), 1 === u.length)) {
        if (
          ...
          if (!(t = (o.find.ID(a.matches[0].replace(Q, Z), t) || [])[0]))
            return n;
          d && (t = t.parentNode), (e = e.slice(r.shift().value.length));
        }
        for (
          s = _.needsContext.test(e) ? 0 : r.length;
          s-- && ((a = r[s]), !o.relative[(l = a.type)]);

        )
          if (
            (c = o.find[l]) &&
            (i = c(
              a.matches[0].replace(Q, Z),
              (V.test(r[0].type) && ae(t.parentNode)) || t
            ))
          ) {
            if ((r.splice(s, 1), !(e = i.length && ue(r))))
    ...
    (ce.prototype = o.filters = o.pseudos),
      (o.setFilters = new ce()),
      (f.sortStable = m.split("").sort(D).join("") === m),
      le(),
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!q(this, "string" == typeof e && I.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var F,
    ...
    if (((n = n || F), "string" == typeof e)) {
      ...
      if (o[1]) {
        if (
          ...
          T.merge(
            this,
            T.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : v, !0)
          ),
          z.test(o[1]) && T.isPlainObject(t))
        )
          for (o in t) h(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
        return this;
      }
      return (
        (i = v.getElementById(o[2])) && ((this[0] = i), (this.length = 1)), this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        T.fn[e] = function (n, o) {
          ...
          return (
            ...
            this.length > 1 &&
              (W[e] || T.uniqueSort(i), R.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (T.Callbacks = function (e) {
    ...
    T.extend({
          ...
          i = {
            ...
            then: function (t, o, i) {
                    ...
                    c = function () {
                      ...
                      if (!(t < s)) {
                        ...
                        (c =
                          ...
                          h(c)
                            ? i
                              ? c.call(e, r(s, n, X, i), r(s, n, Y, i))
                              : (s++,
                                c.call(
                                  e,
                                  r(s, n, X, i),
                                  r(s, n, Y, i),
                                  r(s, n, X, n.notifyWith)
                                ))
                            : (o !== X && ((a = void 0), (l = [e])),
                              (i || n.resolveWith)(a, l));
                      }
              ...
              return T.Deferred(function (e) {
                n[0][3].add(r(0, e, h(i) ? i : X, e.notifyWith)),
                  n[1][3].add(r(0, e, h(t) ? t : X)),
                  n[2][3].add(r(0, e, h(o) ? o : Y));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (U(e, r.done(a(n)).resolve, r.reject, !t),
          "pending" === r.state() || h(s[n] && s[n].then))
        )
          return r.then();
    ...
    T.extend({
      ...
      ready: function (e) {
        (!0 === e ? --T.readyWait : T.isReady) ||
          ((T.isReady = !0),
          (!0 !== e && --T.readyWait > 0) || Q.resolveWith(v, [T]));
      },
    }),
    (T.ready.then = Q.then),
  ...
  var G = function (e, t, n, o, i, s, r) {
      var a = 0,
        l = e.length,
        c = null == n;
      if ("object" === b(n))
        for (a in ((i = !0), n)) G(e, t, a, n[a], !0, s, r);
      else if (
        void 0 !== o &&
        ((i = !0),
        h(o) || (r = !0),
  ...
  function te(e) {
    return e.replace(K, "ms-").replace(J, ee);
  }
  var ne = function (e) {
  ...
  T.extend({
    hasData: function (e) {
      return se.hasData(e) || ie.hasData(e);
    },
    data: function (e, t, n) {
    ...
    T.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = se.get(s)), 1 === s.nodeType && !ie.get(s, "hasDataAttrs"))
          ) {
            for (n = r.length; n--; )
              r[n] &&
                0 === (o = r[n].name).indexOf("data-") &&
                ((o = te(o.slice(5))), le(s, o, i[o]));
  ...
  function be(e, t) {
    for (var n, o, i = [], s = 0, r = e.length; s < r; s++)
      (o = e[s]).style &&
        ...
        t
          ? ("none" === n &&
              ((i[s] = ie.get(o, "display") || null),
              i[s] || (o.style.display = "")),
            "" === o.style.display && ge(o) && (i[s] = ye(o)))
          : "none" !== n && ((i[s] = "none"), ie.set(o, "display", n)));
  ...
  (xe = v.createDocumentFragment().appendChild(v.createElement("div"))),
    ...
    xe.appendChild(we),
    (f.checkClone = xe.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (xe.innerHTML = "<textarea>x</textarea>"),
    (f.noCloneChecked = !!xe.cloneNode(!0).lastChild.defaultValue),
  ...
  function Ee(e, t, n, o, i) {
    ...
    for (u.textContent = "", f = 0; (s = p[f++]); )
      if (o && T.inArray(s, o) > -1) i && i.push(s);
      else if (
        ((c = fe(s)), (r = $e(u.appendChild(s), "script")), c && Pe(r), n)
      )
        for (d = 0; (s = r[d++]); ) ke.test(s.type || "") && n.push(s);
    return u;
  }
  var Le = /^([^.]*)(?:\.(.+)|)/;
  function De() {
        ...
        T.event.add(e, t, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              ...
              o &&
                (ie.set(this, t, T.event.trigger(o[0], o.slice(1), this)),
                e.stopPropagation(),
                (e.isImmediatePropagationStopped = De));
          },
        }))
      : void 0 === ie.get(e, t) && T.event.add(e, t, De);
  }
  (T.event = {
    global: {},
    ...
    remove: function (e, t, n, o, i) {
      ...
      if (v && (l = v.events)) {
        ...
        T.isEmptyObject(l) && ie.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Te.test(t.type) && t.click && k(t, "input") && Me(t, "click", !0),
            !1
          );
        },
        trigger: function (e) {
    ...
    T.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
      ...
      (T.event.special[e] = {
        setup: function () {
          var o;
          if ((Me(this, e, !0), !v.documentMode)) return !1;
          (o = ie.get(this, t)) || this.addEventListener(t, n),
            ie.set(this, t, (o || 0) + 1);
        },
        trigger: function () {
          return Me(this, e), !0;
    ...
    T.fn.extend({
      on: function (e, t, n, o) {
        return He(this, e, t, n, o);
      },
      one: function (e, t, n, o) {
        return He(this, e, t, n, o, 1);
      },
      off: function (e, t, n) {
        var o, i;
  ...
  function Re(e, t) {
    ...
    if (1 === t.nodeType) {
      if (ie.hasData(e) && (a = ie.get(e).events))
        for (i in (ie.remove(t, "handle events"), a))
  ...
  function Be(e, t, n, o) {
    ...
    var i,
      ...
      v = t[0],
      m = h(v);
    if (m || (p > 1 && "string" == typeof v && !f.checkClone && Ie.test(v)))
      return e.each(function (i) {
        var s = e.eq(i);
        m && (t[0] = v.call(this, i, s.html())), Be(s, t, n, o);
      });
    if (
      p &&
      ((r = (i = Ee(t, e[0].ownerDocument, !1, e, o)).firstChild),
      1 === i.childNodes.length && (i = r),
      r || o)
    ) {
      for (l = (a = T.map($e(i, "script"), Fe)).length; u < p; u++)
        (c = i),
          u !== g &&
            ((c = T.clone(c, !0, !0)), l && T.merge(a, $e(c, "script"))),
          n.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, T.map(a, Ne), u = 0; u < l; u++)
          (c = a[u]),
            ke.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : y(c.textContent.replace(ze, ""), c, d));
    }
    return e;
  }
  function _e(e, t, n) {
    for (var o, i = t ? T.filter(t, e) : e, s = 0; null != (o = i[s]); s++)
      n || 1 !== o.nodeType || T.cleanData($e(o)),
        o.parentNode &&
          (n && fe(o) && Pe($e(o, "script")), o.parentNode.removeChild(o));
    return e;
  }
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = $e(a), o = 0, i = (s = $e(e)).length; o < i; o++)
          We(s[o], r[o]);
      if (t)
        if (n)
          for (s = s || $e(e), r = r || $e(a), o = 0, i = s.length; o < i; o++)
            Re(s[o], r[o]);
        else Re(e, a);
      return (
        (r = $e(a, "script")).length > 0 && Pe(r, !l && $e(e, "script")), a
      );
    },
    cleanData: function (e) {
      for (var t, n, o, i = T.event.special, s = 0; void 0 !== (n = e[s]); s++)
        if (ne(n)) {
          if ((t = n[ie.expando])) {
            if (t.events)
              for (o in t.events)
    ...
    T.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (T.cleanData($e(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < o; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (T.cleanData($e(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Be(
          ...
          function (t) {
            ...
            T.inArray(this, e) < 0 &&
              (T.cleanData($e(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    T.each(
      ...
      function (e, t) {
        T.fn[e] = function (e) {
          for (var n, o = [], i = T(e), s = i.length - 1, a = 0; a <= s; a++)
  ...
  function rt(e, t, n, o, i, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (c += T.css(e, n + ue[r], !0, i)),
        o
          ? ("content" === n && (l -= T.css(e, "padding" + ue[r], !0, i)),
            "margin" !== n &&
              (l -= T.css(e, "border" + ue[r] + "Width", !0, i)))
          : ((l += T.css(e, "padding" + ue[r], !0, i)),
            "padding" !== n
              ? (l += T.css(e, "border" + ue[r] + "Width", !0, i))
              : (a += T.css(e, "border" + ue[r] + "Width", !0, i)));
    return (
      !o &&
        s >= 0 &&
        (l +=
  ...
  function at(e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && i) ||
        ...
        "auto" === r ||
        (!parseFloat(r) && "inline" === T.css(e, "display", !1, o))) &&
        e.getClientRects().length &&
        ((i = "border-box" === T.css(e, "boxSizing", !1, o)),
        (s = a in e) && (r = e[a])),
      (r = parseFloat(r) || 0) +
        rt(e, t, n || (i ? "border" : "content"), s, o, r) +
        "px"
    );
  }
  function lt(e, t, n, o, i) {
    return new lt.prototype.init(e, t, n, o, i);
  }
  T.extend({
    cssHooks: {
      opacity: {
    ...
    style: function (e, t, n, o) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          c = e.style;
        if (
          (l || (t = tt(a)), (r = T.cssHooks[t] || T.cssHooks[a]), void 0 === n)
        )
      ...
      T.cssHooks[t] = {
        ...
        set: function (e, n, o) {
          var i,
            ...
            a = (r || o) && "border-box" === T.css(e, "boxSizing", !1, s),
            l = o ? rt(e, t, o, a, s) : 0;
          return (
            a &&
              r &&
    ...
    (T.cssHooks.marginLeft = Ge(f.reliableMarginLeft, function (e, t) {
      if (t)
        return (
    ...
    T.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      (T.cssHooks[e + t] = {
        expand: function (n) {
          for (
            var o = 0, i = {}, s = "string" == typeof n ? n.split(" ") : [n];
            o < 4;
            o++
          )
            i[e + ue[o] + t] = s[o] || s[o - 2] || s[0];
          return i;
        },
      }),
  ...
  function mt(e, t, n) {
    ...
    for (
      ...
      if ((o = mt.prefilters[s].call(c, e, d, c.opts)))
        return (
          h(o.stop) &&
  ...
  (T.Animation = T.extend(mt, {
    tweeners: {
      "*": [
        function (e, t) {
          ...
          return ve(n.elem, e, de.exec(t), n), n;
        },
      ],
    },
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && be([e], !0),
              p.done(function () {
                for (o in (g || be([e]), ie.remove(e, "fxshow"), f))
                  T.style(e, o, f[o]);
              })),
              (l = vt(g ? v[o] : 0, o, p)),
              o in v ||
    ...
    (T.speed = function (e, t, n) {
      ...
      return (
        ...
        (o.old = o.complete),
        (o.complete = function () {
          h(o.old) && o.old.call(this), o.queue && T.dequeue(this, o.queue);
        }),
        o
      );
    }),
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (i in r) r[i] && r[i].stop && pt.test(i) && o(r[i]);
            for (i = s.length; i--; )
              s[i].elem !== this ||
                (null != e && s[i].queue !== e) ||
    ...
    T.fn.extend({
      addClass: function (e) {
        ...
        return h(e)
          ...
          ? this.each(function () {
              if (
                ((o = St(this)), (n = 1 === this.nodeType && " " + Tt(o) + " "))
              ) {
                for (s = 0; s < t.length; s++)
                  (i = t[s]), n.indexOf(" " + i + " ") < 0 && (n += i + " ");
                (r = Tt(n)), o !== r && this.setAttribute("class", r);
              }
            })
          : this;
      },
      ...
      toggleClass: function (e, t) {
        ...
        return h(e)
          ...
          : ((n = kt(e)),
            this.each(function () {
              if (a)
                for (s = T(this), i = 0; i < n.length; i++)
                  (o = n[i]), s.hasClass(o) ? s.removeClass(o) : s.addClass(o);
              else
                (void 0 !== e && "boolean" !== r) ||
                  ((o = St(this)) && ie.set(this, "__className__", o),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      o || !1 === e ? "" : ie.get(this, "__className__") || ""
                    ));
            }));
      },
      hasClass: function (e) {
    ...
    T.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, o, i = e.options, s = T.makeArray(t), r = i.length;
              r--;

            )
              ((o = i[r]).selected =
                T.inArray(T.valHooks.option.get(o), s) > -1) && (n = !0);
  ...
  T.extend(T.event, {
    trigger: function (t, n, o, i) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          8 !== o.nodeType &&
          !Et.test(y + T.event.triggered) &&
          (y.indexOf(".") > -1 &&
            ((b = y.split(".")), (y = b.shift()), b.sort()),
          (c = y.indexOf(":") < 0 && "on" + y),
          ((t = t[T.expando]
            ? t
            : new T.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = b.join(".")),
        ...
        if (!i && !p.noBubble && !g(o)) {
          for (
            l = p.delegateType || y, Et.test(l + y) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            m.push(r), (a = r);
        ...
        for (s = 0; (r = m[s++]) && !t.isPropagationStopped(); )
          (f = r),
            ...
            (u =
              (ie.get(r, "events") || Object.create(null))[t.type] &&
              ie.get(r, "handle")) && u.apply(r, n),
            (u = c && r[c]) &&
              u.apply &&
              ne(r) &&
        ...
        return (
          ...
          i ||
            ...
            (c &&
              ...
              ((a = o[c]) && (o[c] = null),
              (T.event.triggered = y),
              t.isPropagationStopped() && f.addEventListener(y, Lt),
              o[y](),
              t.isPropagationStopped() && f.removeEventListener(y, Lt),
  ...
  function Ot(e, t, n, o) {
    ...
    else for (i in t) Ot(e + "[" + i + "]", t[i], n, o);
  }
            ...
            u
              ? (f.ifModified &&
                ...
                204 === t || "HEAD" === f.type
                  ...
                  : 304 === t
                  ? (S = "notmodified")
                  : ((S = x.state), (p = x.data), (u = !(v = x.error))))
  ...
  T.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Kt.pop() || T.expando + "_" + Pt.guid++;
      return (this[e] = !0), e;
    },
  }),
    T.ajaxPrefilter("json jsonp", function (t, n, o) {
      var i,
        s,
        r,
        a =
      ...
      if (a || "jsonp" === t.dataTypes[0])
        return (
          ...
          o.always(function () {
            void 0 === s ? T(e).removeProp(i) : (e[i] = s),
    ...
    (f.createHTMLDocument =
      (((Gt = v.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (T.fn.load = function (e, t, n) {
      var o,
        ...
        a = e.indexOf(" ");
      return (
        a > -1 && ((o = Tt(e.slice(a))), (e = e.slice(0, a))),
        h(t)
          ? ((n = t), (t = void 0))
        ...
        r.length > 0 &&
          T.ajax({ url: e, type: i || "GET", dataType: "html", data: t })
            .done(function (e) {
              (s = arguments),
                r.html(o ? T("<div>").append(T.parseHTML(e)).find(o) : e);
            })
            .always(
              n &&
                function (e, t) {
      ...
      setOffset: function (e, t, n) {
        ...
        "static" === c && (e.style.position = "relative"),
          ...
          ("absolute" === c || "fixed" === c) && (s + l).indexOf("auto") > -1
            ? ((r = (o = d.position()).top), (i = o.left))
            : ((r = parseFloat(s) || 0), (i = parseFloat(l) || 0)),
          h(t) && (t = t.call(e, n, T.extend({}, a))),
    ...
    T.each(["top", "left"], function (e, t) {
      T.cssHooks[t] = Ge(f.pixelPosition, function (e, n) {
        if (n)
          return (n = Ze(e, t)), Xe.test(n) ? T(e).position()[t] + "px" : n;
      });
    }),
      ...
      (e && e.isDefaultPrevented()) ||
        ...
        ((s = n.fancybox.getInstance()) && s.$trigger && s.$trigger.is(o)) ||
          (t.selector
            ...
            ? (r = (r = e.data ? e.data.items : []).length
      ...
      n.extend(g.prototype, {
        ...
        jumpTo: function (e, t) {
          ...
          if (!(f.isDragging || f.isClosing || (f.isAnimating && f.firstRun))) {
            ...
            if (
              ...
              (r = f.createSlide(e)),
              h > 1 &&
                ((s || r.index < h - 1) && f.createSlide(e + 1),
              ...
              n.isNumeric(t)
                ? (r.forcedDuration = t)
                : (t = r.opts[o ? "animationDuration" : "transitionDuration"]),
              (t = parseInt(t, 10)),
              (i = f.isMoved(r)),
        ...
        scaleToActual: function (e, t, o) {
          ...
          c.isAnimating ||
            ...
            (r = 0.5 * f - 0.5 * g),
            h > p &&
              ((s = i.left * a - (e * a - e)) > 0 && (s = 0),
              s < p - h && (s = p - h)),
            g > f &&
              ((r = i.top * l - (t * l - t)) > 0 && (r = 0),
              r < f - g && (r = f - g)),
            c.updateCursor(h, g),
            n.fancybox.animate(
              u,
        ...
        getFitPos: function (e) {
          ...
          return (
            ...
            "image" === e.type
              ? ((d.top =
                  Math.floor(0.5 * (o - c)) + parseFloat(a.css("paddingTop"))),
                (d.left =
                  Math.floor(0.5 * (t - l)) + parseFloat(a.css("paddingLeft"))))
              : "video" === e.contentType &&
                (c >
                l /
                  (s =
        ...
        updateSlide: function (e, t) {
          ...
          o.adjustCaption(e),
            i &&
              ...
              e.pos === o.currPos && ((o.isAnimating = !1), o.updateCursor())),
            o.adjustLayout(e),
            a.length &&
              (a.trigger("refresh"),
              e.pos === o.currPos &&
        ...
        afterLoad: function (e) {
          ...
          t.isClosing ||
            ...
            !e.opts.smallBtn ||
              ...
              (e.$smallBtn = n(t.translate(e, e.opts.btnTpl.smallBtn)).appendTo(
                e.$content
              )),
            e.opts.protect &&
              e.$content &&
        ...
        revealContent: function (e) {
          ...
          return (
            ...
            (i =
              e.opts[r.firstRun ? "animationDuration" : "transitionDuration"]),
            (i = parseInt(
            ...
            "zoom" === t
              ? ((r.isAnimating = !0),
                ...
                "auto" == (s = e.opts.zoomOpacity) &&
                  (s = Math.abs(e.width / e.height - c.width / c.height) > 0.1),
        ...
        complete: function () {
          ...
          !t.isMoved() &&
            ...
            o.opts.autoFocus &&
              "html" === o.contentType &&
              ((e = o.$content.find("input[autofocus]:enabled:visible:first"))
                .length
                ? e.trigger("focus")
                : t.focus(null, !0)),
              ...
              : (u.removeEvents(),
                ...
                "zoom" === o
                  ? (n.fancybox.stop(s),
                    ...
                    "auto" == a &&
                      (a =
                        Math.abs(f.width / f.height - d.width / d.height) >
                        0.1),
                    a && (d.opacity = 0),
      ...
      (r = e.extend(!0, {}, t, s.opts.media)),
        e.each(r, function (t, o) {
          if ((l = f.match(o.matcher))) {
            if (
              ((h = o.type), (p = t), (u = {}), o.paramPlace && l[o.paramPlace])
            ) {
  ...
  (function (e, t, n) {
    ...
    (d.prototype.destroy = function () {
      ...
      (d.prototype.limitPosition = function (e, t, n, o) {
        ...
        return (
          n > i
            ? (e = (e = e > 0 ? 0 : e) < i - n ? i - n : e)
            : (e = Math.max(0, i / 2 - n / 2)),
          o > s
            ? (t = (t = t > 0 ? 0 : t) < s - o ? s - o : t)
            : (t = Math.max(0, s / 2 - o / 2)),
          { top: t, left: e }
        );
      }),
    ...
    t.extend(o.prototype, {
      ...
      create: function () {
        ...
        o.$grid ||
          ...
          o.$list ||
            (o.$list = t('<div class="' + n + '__list">').appendTo(o.$grid)),
      ...
      t(e).on("click", "[data-fancybox-share]", function () {
        ...
        i &&
          ("function" === t.type(i.opts.share.url) &&
            (e = i.opts.share.url.apply(i, [o, i])),
          (n = i.opts.share.tpl
            .replace(
              /\{\{media\}\}/g,
          ...
          case "previous":
            (i =
              ...
              s.slideCount > s.options.slidesToShow &&
                s.slideHandler(s.currentSlide - i, !1, n);
            break;
          case "next":
              ...
              .each(function (n) {
                ...
                e(this).attr({
                  ...
                  -1 !== i &&
                    e(this).attr({
                      "aria-describedby":
                        "slick-slide-control" + t.instanceUid + i,
                    });
              }),
            t.$dots
              .attr("role", "tablist")
        ...
        if (
          (!0 === s.options.centerMode
            ...
            : ((o = s.options.infinite
              ...
              !0 === s.options.fade &&
                (o > 0 && o--, i <= s.slideCount && i++)),
          (n = s.$slider.find(".slick-slide").slice(o, i)),
          "anticipated" === s.options.lazyLoad)
        )
          for (
            var r = o - 1, a = i, l = s.$slider.find(".slick-slide"), c = 0;
